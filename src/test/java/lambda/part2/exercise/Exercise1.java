...
public class Exercise1 {
    ...
    public void sameAgesCheckerUsingBiPredicate() {
        ...
        BiPredicate<Person, Person>  sameAgesChecker = (persona1, persona2) -> persona1.getAge()==persona2.getAge();
    ...
    private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> getFullName) {
        return (person1, person2) -> getFullName(person1).length()>getFullName(person2).length()? person1.getAge(): person2.getAge();
    }
